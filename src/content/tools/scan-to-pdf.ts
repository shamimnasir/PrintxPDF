...
export const scanToPdf: ToolContent = {
  ...
  faqs: [
    ...
    { q: 'Can I use photos I took earlier instead of the camera?', a: 'Yes. Drop JPG, PNG or HEIC photos onto the drop zone and they join the filmstrip like captured pages. If another app needs JPG, convert them first with the [HEIC to JPG converter](/tools/heic-to-jpg).' },
